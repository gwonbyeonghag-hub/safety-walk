...
enum LocalizationKey: String {
    ...
    // MARK: - TBM Safety Briefing (WO LEGAL-TBM-2)
    case tbmTitle                = "tbm.title"
    case tbmHomeCardSubtitle     = "tbm.home.cardSubtitle"
    case tbmNew                  = "tbm.new"
    case tbmEmpty                = "tbm.empty"
    // Create
    case tbmTaskDescription            = "tbm.taskDescription"
    case tbmTaskDescriptionPlaceholder = "tbm.taskDescription.placeholder"
    case tbmOccurredAt                 = "tbm.occurredAt"
    case tbmLocation                   = "tbm.location"
    case tbmLocationPlaceholder        = "tbm.location.placeholder"
    case tbmSite                       = "tbm.site"
    case tbmSiteNone                   = "tbm.site.none"
    case tbmProfile                    = "tbm.profile"
    case tbmProfileNotSet              = "tbm.profile.notSet"
    case tbmProfileKRTBM               = "tbm.profile.krTBM"
    case tbmProfileUSCAConstruction    = "tbm.profile.usCAConstruction"
    case tbmProfileUSElectric          = "tbm.profile.usElectric"
    case tbmProfileUSGeneral           = "tbm.profile.usGeneral"
    case tbmLinkedAssessment           = "tbm.linkedAssessment"
    case tbmLinkedAssessmentNone       = "tbm.linkedAssessment.none"
    case tbmLinkedAssessmentMissing    = "tbm.linkedAssessment.missing"
    case tbmSaveFailedMessage          = "tbm.save.failedMessage"
    // Status
    case tbmStatus           = "tbm.status"
    case tbmStatusDraft      = "tbm.status.draft"
    case tbmStatusConducted  = "tbm.status.conducted"
    case tbmStatusFinalized  = "tbm.status.finalized"
    case tbmStatusCancelled  = "tbm.status.cancelled"
    // Content · lifecycle
    case tbmContent               = "tbm.content"
    case tbmContentLockedHint     = "tbm.content.lockedHint"
    case tbmConduct               = "tbm.conduct"
    case tbmConductHint           = "tbm.conduct.hint"
    case tbmConductFailedTitle    = "tbm.conduct.failedTitle"
    case tbmConductFailedMessage  = "tbm.conduct.failedMessage"
    case tbmFinalize              = "tbm.finalize"
    case tbmFinalizeHint          = "tbm.finalize.hint"
    case tbmFinalizeFailedTitle   = "tbm.finalize.failedTitle"
    case tbmFinalizeFailedMessage = "tbm.finalize.failedMessage"
    case tbmCancel                = "tbm.cancel"
    case tbmCancelTitle           = "tbm.cancel.title"
    case tbmCancelReasonPlaceholder = "tbm.cancel.reasonPlaceholder"
    case tbmCancelFailedTitle     = "tbm.cancel.failedTitle"
    case tbmCancelFailedMessage   = "tbm.cancel.failedMessage"
    case tbmCancellationReason    = "tbm.cancellationReason"
    // Risk snapshots (read-only, value-copied at conduct)
    case tbmRiskSnapshotsSection  = "tbm.riskSnapshots.section"
    case tbmRiskSnapshotsEmpty    = "tbm.riskSnapshots.empty"
    // Participants
    case tbmParticipants                 = "tbm.participants"
    case tbmParticipantsEmpty            = "tbm.participants.empty"
    case tbmParticipantAdd               = "tbm.participant.add"
    case tbmParticipantNamePlaceholder   = "tbm.participant.namePlaceholder"
    case tbmParticipantConfirmedAt       = "tbm.participant.confirmedAt"
