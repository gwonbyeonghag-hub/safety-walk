...
> 병합 후 검증(fast-forward, merge commit 없음): **Core `swift test` 327/327**(43 suites) · iOS·Mac 서명 빌드 둘 다 `BUILD SUCCEEDED` · `ReportRenderingTests` 15/15 개별 재확인(신규 업종 미기록 테스트 2건 포함) · `git diff --check main...HEAD` clean · 병합 전 working tree clean.
